 ...
 * 
 * Encryption usage : 
 *   // prepare public key by Actor1
 *   EncryptionManager encryptionManager = EncryptionManager.getEncryptionManager();
 *   String publicKey = encryptionManager.getPublicKeyAsString(); // publicKey is given to Actor2
 * 
 *   // ecryption by Actor2 thanks to the publicKey
 *   String ecryptedString = EncryptionManager.encrypt("test", publicKey);
 * 
 *   //decryption by Actor1
 *   String result = encryptionManager.decrypt(ecryptedString);
 * 
 * @author JM235353
 */
