...
public final class PropertiesUtils {
	 ...
	 * <p>
	 * Warning : Properties file are loaded via <code>InputStream</code> which assumed to use the ISO 8859-1 character encoding.
	 * 
	 * @param name
	 *            Name of the properties file (must not be <code>null</code> or empty). This method first search the properties file as a resource via current
	 *            <code>ClassLoader</code>. If the properties file is not found in class path, this method tries to load it as a regular file (absolute or
	 *            relative to current directory).
	 * @return The loaded <code>Properties</code> instance or <code>null</code> if the file is not found or an I/O error occurs.
	 */
	 ...
	 * @param key
	 *            Key of the property (must not be <code>null</code> : <code>Properties</code> is a <code>Hashtable</code>).
	 * @return Property value as String or <code>null</code> if not defined or the value is not a <code>String</code> instance.
	 */
