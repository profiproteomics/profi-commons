...
public final class DateUtils {
	 ...
	 * @return <code>Date</code> object or <code>null</code> if <code>rawString</code> is empty or invalid format.
	 */
	 ...
	 * @return Release date as a String (format : yyyymmdd) or <code>null</code> if <code>date</code> is invalid.
	 */
	 ...
	 */
	public static Date clearTime(final Date src) {
